...
# 🌟 ระบบจำเวลาแจ้งเตือนผ่าน Firebase (กันเวลากด F5 แล้วค่ารีเซ็ต)
...
if saved_time_str:
    ...
    default_alert_time = dt_time(8, 0) # ค่าเริ่มต้น 08:00

alert_time = st.sidebar.time_input("เลือกเวลาส่งสรุปผล", value=default_alert_time)

# ตรวจสอบว่าผู้ใช้กดเปลี่ยนเวลาในหน้าเว็บหรือเปล่า? ถ้าเปลี่ยนก็เซฟลง Firebase
